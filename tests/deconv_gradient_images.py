...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        dest='config_file',
        type=str,
        default='/home/drew/Documents/deconv_analysis/2d_one/training_config_file.npy',
        help='Location of config file.')
    parser.add_argument(
        '--ckpt',
        dest='ckpt_file',
        type=str,
        default='/media/data_cifs/contextual_circuit/checkpoints/crcns_2d_two_loss_2018_01_28_17_03_53/model_45500.ckpt-45500',
        help='Location of config file.')
    parser.add_argument(
        '--list_experiments',
